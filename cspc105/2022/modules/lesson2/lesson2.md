...
$$ Students \times Subjects = \{ (alice, automata), (alice, intel sys), (bob, automata), (bob, intel sys), (carl, automata), (carl, intel sys) \} $$
...
$$ G = (\{ 1, 2, 3, 4, 5 \}, \{ (1, 2), (1, 3), (3, 4), (4, 3), (3, 5), (5, 4),\}) $$
